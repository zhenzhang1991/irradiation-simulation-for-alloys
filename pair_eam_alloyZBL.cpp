...
PairEAMAlloyZBL::PairEAMAlloyZBL(LAMMPS *lmp) : PairEAMZBL(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
}
...
void PairEAMAlloyZBL::coeff(int narg, char **arg)
{
  int i,j;
...
void PairEAMAlloyZBL::read_file(char *filename)
{
  Setfl *file = setfl;
...
void PairEAMAlloyZBL::file2array()
{
  int i,j,m,n;

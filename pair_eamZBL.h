...
PairStyle(eamZBL,PairEAMZBL)

#else

#ifndef LMP_PAIR_EAMZBL_H
#define LMP_PAIR_EAMZBL_H
...
class PairEAMZBL : public Pair {
 ...
 protected:
  ...
  double F_fermi(double);
  double F_fermi_d(double);
